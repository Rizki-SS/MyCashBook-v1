...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var add_money: ImageView
    lateinit var subtract_money: ImageView
    lateinit var setting_money : ImageView
    lateinit var detail_money : ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        filter = findViewById(R.id.apply)
